...
import com.xyvona.flavorville.data.ProductHighlightState
import com.xyvona.flavorville.data.ProductHighlightType
...
private fun Highlight(
    modifier: Modifier = Modifier,
    text: String,
    colors: HighlightColors = HighlightDefaults.defaultColor
) {
    Surface(
        modifier = modifier,
